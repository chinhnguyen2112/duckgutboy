            ...
            <div class="body_noti_gif">
                <div class="body_gif_nav">
                    <div class="box_text_noti">
                        ...
                        <p class="text_cacbuoc">- Sau khi đã có tài khoản game, tại trang chủ của Duckgutboy bạn chọn “Mini game => Liên quân mobile” để chơi vòng quay may mắn. Bạn sẽ chọn thể loại vòng quay mà bạn thích và nhấn giữ chọn góc quay mà bạn mong muốn. Sau khi kim dừng lại thì phần quà của bạn sẽ hiện ra ở giữa màn hình.</p>
                    </div>
                </div>
            </div>
            <div class="box_close_gif">
            ...
            <div class="body_noti_gif">
                <div class="body_gif_nav">
                    <div class="box_text_noti">
                        ...
                        <p class="nav_cac_buoc">Zen: <span>sử dụng mua các sản phẩm trong shop Duckgutboy.</span></p>
            ...
            <div class="body_noti_gif">
                <div class="body_gif_nav">
                    <div class="box_text_noti">
                        ...
                        <p>Đăng kí ngay kênh Youtube của Duckgutboy nhận ngay lượt quay miễn phí 9.000đ.</p>
            ...
            $.ajax({
                ...
                success: function(data) { // 
                    if (data.status == 0) {
                        ...
                        setCookies('url_301', 'https://duckgutboy.com/vong-quay-lien-quan/', 1)
