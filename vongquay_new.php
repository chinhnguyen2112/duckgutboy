...
setcookie('luotquay_free', ($data_user['luotquay_free'] < 0) ? 0 : $data_user['luotquay_free'], time() + 86400, '/');
...
$s = date('s', $tgian);
?>
<link rel="stylesheet" href="/assets/css/sanacc/css_vq_new.css?v=<?= time() ?>">
<div id="main">
    <div class="content">
        <div class="div_close">
            <span class="close_page" onclick=" window.location.href = '/';">trang chủ</span>
            <span class="close_page" onclick=" khodo()">Kho đồ</span>
            <span class="close_page" onclick=" login_vq()"><?= (isset($data_user) && $data_user['id'] > 0) ? 'Đăng xuất' : 'Đăng nhập' ?></span>
        </div>
        <div class="title_box">
        ...
        <div class="choose_spin_tablet">
            <select name="" id="change_type">
                ...
                <option value="luotquay">Vòng quay siêu phẩm</option>
        ...
        <div class="box_spin">
            <div class="box-left">
                <div class="header-title">
                    ...
                    <audio id="hi">
                        <source src="/images/sanacc/vqlq/Untitled.mp3" type="audio/mp3">
                    </audio>
                    ...
                    <div class="list_box_vp vp_1">
                        <div class="box_vip_1">
                            <img src="/images/sanacc/vqlq/vp_acc.png" alt="tay cầm chơi game" style="margin-top: 32%;">
                            <!-- <p>Acc V.I.P</p> -->
                        </div>
                        <div class="box_vip_2">
                            <img src="/images/sanacc/vqlq/vp_qh.png" alt="bao tay chơi game" style="margin-top: 40%; margin-left:21%">
                            <!-- <p>1000</p> -->
                        </div>
                        <div class="box_vip_3">
                            <img src="/images/sanacc/vqlq/vp_skin.png" alt="tai nge chơi game" style="margin-top: 32%;">
                            <!-- <p>Acc thường</p> -->
                        </div>
                ...
                <div class="rotation_box">
                    <div class="spin-img">
                        <img class="img_spin_img" src="/images/sanacc/vqlq/vq_random.png" alt="rotation">
                        <div class="muiten_quay">
                            <img class="img_muiten" src="/images/sanacc/vqlq/muiten.png" alt="Mũi tên">
                        </div>
                        <img src="/images/sanacc/vqlq/center_vq.png" class="img_rank_center" alt="vòng quay">
                    </div>
                    <div class="text-spin">
                        <div class="box_count_turn">
                            <img src="/images/sanacc/vqlq/count_turn.png" alt="lượt quay">
                            <span class="span_count_play">Lượt: <?= (isset($data_user) && $data_user['luotquay_free'] >= 0) ? $data_user['luotquay_free'] : '0' ?></span>
                        </div>
            ...
            <div class="box-right">
                <div class="choose_spin">
                    <div class="game-board">
                        ...
                        <li class="li_type_lq" data-type="luotquay"><span class="span_type_lq">Vòng quay siêu phẩm</span></li>
    ...
    <div class="box_noti_gif popup_happy">
        <div class="body_gif" style="background: url(/images/sanacc/vqlq/img_bgr_tb.png);background-size: 100% 100%; position:relative;width:600px">
                ...
                <div class="body_gif_nav">
                    <div class="div_img_noti" style=" display:block;min-height: 220px;">
                        <div class="box_this_gif">
                            <img class="img_gif_this" style="margin-top: 30px;width: 25%;" src="/images/sanacc/danhmuc/ct_right.png" alt="phần thưởng">
                        </div>
                    </div>
            ...
            <img style="width:50px; position:absolute;top:-10px;right:-1px" src="/images/sanacc/vqlq/dong_tb.png" onclick="$('.popup_happy').hide();" alt="đóng">
        </div>
    </div>
    <!-- popup lịch sử quay -->
            ...
            <div class="body_noti_gif">
                <div class="body_gif_nav">
                    <div class="box_text_noti">
                        ...
                        <p class="text_cacbuoc">- Tại Duckgutboy có hai cách đăng ký tài khoản đó là: Facebook và Tên đăng nhập.</p>
                        <p class="cac_buoc">Bước 2: <span>Tham gia chơi vòng quay may mắn.</span></p>
                        <p class="text_cacbuoc">- Sau khi đã có tài khoản game, tại trang chủ của Duckgutboy bạn chọn “Mini game => Liên quân mobile” để chơi vòng quay may mắn.</p>
            ...
            <div class="body_noti_gif">
                <div class="body_gif_nav">
                    <div class="box_text_noti">
                        ...
                        <p class="nav_nav_cac_buoc"><img class="img_box_uudai" src="/images/sanacc/detail/send.svg" alt="ưu đãi 1">Acc Liên quân từ 8-50 tướng.</p>
                        <p class="nav_nav_cac_buoc"><img class="img_box_uudai" src="/images/sanacc/detail/send.svg" alt="ưu đãi 1">50-1000 quân huy</p>
                        <p class="nav_nav_cac_buoc"><img class="img_box_uudai" src="/images/sanacc/detail/send.svg" alt="ưu đãi 1">50 Zen.</p>
                        <p class="nav_nav_cac_buoc"><img class="img_box_uudai" src="/images/sanacc/detail/send.svg" alt="ưu đãi 1">Voucher giảm 100.000đ khi mua acc từ 500.000đ.</p>
                        <p class="nav_nav_cac_buoc"><img class="img_box_uudai" src="/images/sanacc/detail/send.svg" alt="ưu đãi 1">Skin bậc A - bậc SS.</p>
                        <p class="nav_nav_cac_buoc"><img class="img_box_uudai" src="/images/sanacc/detail/send.svg" alt="ưu đãi 1">Phiếu phần thưởng.</p>
                        <p class="nav_nav_cac_buoc"><img class="img_box_uudai" src="/images/sanacc/detail/send.svg" alt="ưu đãi 1">Mảnh ghép skin.</p>
    ...
    <div class="box_noti_gif popup_nhiem_vu">
        <div class="body_gif">
            ...
            <div class="body_noti_gif">
                <div class="body_gif_nav">
                    <div class="box_text_noti">
                        <p><img class="img_box_uudai" src="/images/sanacc/detail/send.svg" alt="ưu đãi 1">Đăng kí hoặc đăng nhập tài khoản tại Duckgutboy vào khung giờ vàng để nhận ngay 3 lượt quay nhiệm vụ.</span></p>
                        <p><img class="img_box_uudai" src="/images/sanacc/detail/send.svg" alt="ưu đãi 1">Giới thiệu 1 bạn chơi mới nhận ngay 1 lượt quay vòng quay nhiệm vụ.</span></p>
                        <p><img class="img_box_uudai" src="/images/sanacc/detail/send.svg" alt="ưu đãi 1">Khi mua acc từ 200.000đ được tặng 1 lượt quay tự chọn.</p>
                        <p><img class="img_box_uudai" src="/images/sanacc/detail/send.svg" alt="ưu đãi 1">Tích điểm sau mỗi lần mua acc, đủ 20 điểm khách hàng sẽ được tặng 1 lượt quay tự chọn.</p>
                    </div>
                </div>
            </div>
            <div class="box_close_gif">
    ...
    <div style="display: none;" class="popup_buy_spin">
        <div class="body_buy_spin">
            <img onclick="$('.popup_buy_spin').hide();" class="close_buy_spin" src="/images/sanacc/vqlq/dong_tb.png" alt="close_popup">
            <div class="buy_spin_container">
                ...
                <div class="box_buy_spin">
                    <div class="left_box">
                        <img src="/images/sanacc/vqlq/vq_random.png" alt="popup">
...
<script src="/assets/js/zendo/js_vqlq.js?v=<?= time() ?>"></script>